...
App sinh nhạc có 3 đường realtime: audio callback (3.5ms mỗi vòng), UI 60fps (16.6ms mỗi frame), và tương tác generate (người dùng chờ). Cả ba đều fail *mềm* — app không crash, chỉ trở nên khó chịu. Không gắn vào CI thì regression trôi qua review.
